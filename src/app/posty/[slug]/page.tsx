...
export default async function PostPage({ params: { slug } }: Props) {
  ...
  return (
    <article className='prose prose-invert mx-auto max-w-prose md:prose-lg lg:prose-xl prose-headings:text-secondary prose-h4:italic prose-h4:text-white prose-p:text-justify'>
      <PostHeader
        date={date}
        excerpt={excerpt}
        thumbnail={thumbnail}
